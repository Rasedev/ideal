...
//   // Filter members when filters or members change
//   useEffect(() => {
//     filterMembers();
//   }, [members, searchText, statusFilter, membershipTypeFilter]);
...
//       subscriptionStatus: member.subscriptionStatus || 'pending',
...
//         paymentDue: values.paymentDue ? values.paymentDue.format('YYYY-MM-DD') : null
//       };
...
//       } else {
//         // Add new member
//         await dispatch(createMember(formattedValues)).unwrap();
//         message.success('Member added successfully');
//       }
...
//           // Handle batch delete
//           await Promise.all(
//             selectedRowKeys.map(id => dispatch(deleteMember(id)).unwrap())
//           );
//           message.success('Selected members deleted successfully');
//           break;
...
//         <Space direction="vertical" size="small">
//           {getMembershipTypeTag(type)}
//           {record.subscriptionStatus && getSubscriptionStatusTag(record.subscriptionStatus)}
//         </Space>
//       ),
//     },
//     {
...
//       sorter: (a, b) => dayjs(a.joinDate || 0).unix() - dayjs(b.joinDate || 0).unix(),
//     },
//     {
//       title: 'Actions',
//       key: 'actions',
...
//                   type="text" 
//                   icon={<CheckCircleOutlined />} 
//                   onClick={() => handleApproveMember(record._id || record.id)}
//                   className="text-green-500"
//                 />
//               </Tooltip>
//               <Tooltip title="Reject">
...
//                   type="text" 
//                   icon={<CloseCircleOutlined />} 
//                   onClick={() => handleRejectMember(record._id || record.id)}
//                   className="text-red-500"
//                 />
//               </Tooltip>
//             </>
...
//             title="Delete Member"
//             description="Are you sure you want to delete this member?"
//             onConfirm={() => handleDeleteMember(record._id || record.id)}
//             okText="Yes"
//             cancelText="No"
//           >
//             <Tooltip title="Delete">
...
//   // Calculate local stats if not provided by API
...
//                 label="Membership ID"
//               >
//                 <Input placeholder="Auto-generated if empty" disabled={!!selectedMember} />
//               </Form.Item>
//             </Col>
//             <Col span={12}>
//               <Form.Item
...
//                     <div>
//                       <div className="text-sm text-gray-500">Next Payment</div>
//                       <div>{dayjs(viewMember.paymentDue).format('DD MMM YYYY')}</div>
//                     </div>
//                   </Col>
//                 )}
//               </Row>
...
//             {/* Location Information */}
//             {(viewMember.division || viewMember.district) && (
//               <div>
//                 <h4 className="font-semibold mb-3">Location</h4>
//                 <Row gutter={[16, 16]}>
//                   {viewMember.division && (
